...
export default new Router({
    routes: [{
            ...
            children: [{
                ...
                {
                    path: '/addEnterprise',
                    component: () => import( /* webpackChunkName: "addEnterprise" */ '../components/merchantHoutai/terrace/addEnterprise.vue'),
                    // component: Index,
                    meta: {
                        title: '添加企业'
                    }
                ...
                {
                    path: '/editEnterprise',
                    component: () => import( /* webpackChunkName: "editEnterprise" */ '../components/merchantHoutai/terrace/editEnterprise.vue'),
                    // component: Index,
                    meta: {
                        title: '编辑企业'
                    }
                ...
                {
                    path: '/workadmin',
                    component: () => import( /* webpackChunkName: "workadmin" */ '../components/merchantHoutai/workAdmin/workadmin.vue'),
                    // component: Index,
                    meta: {
                        title: '团队管理'
                    }
                ...
                },
                {
                    ...
                    component: () => import( /* webpackChunkName: "ManagePositions" */ '../components/merchantHoutai/workAdmin/ManagePositions.vue'),
                    // component: Index,
                    meta: {
                        title: '职位管理'
                    }
                ...
                {
                    path: '/membership',
                    component: () => import( /* webpackChunkName: "membership" */ '../components/merchantHoutai/workAdmin/membership/membership.vue'),
                    // component: Index,
                    meta: {
                        title: '会员列表'
                    }
                ...
                {
                    path: '/addPeople',
                    component: () => import('../view/Sharing-Qianlima/Personnel-gl/addPeople/addPeople.vue'),
                    // component: Index,
                    meta: {
                        title: '添加人员'
                    }
                ...
                {
                    path: '/Orderment',
                    component: () => import('../view/Sharing-Qianlima/Orderment/Orderment.vue'),
                    // component: Index,
                    meta: {
                        title: '订单设置'
                    },
                    children: [{
                        ...
                        {
                            path: '/haveInHand',
                            component: () => import('../view/Sharing-Qianlima/Orderment/haveInHand/haveInHand.vue'),
                            // component: Index,
                            meta: {
                                title: '进行中'
                            }
                        ...
                        {
                            path: '/CompletedPage',
                            component: () => import('../view/Sharing-Qianlima/Orderment/CompletedPage/CompletedPage.vue'),
                            // component: Index,
                            meta: {
                                title: '已完成'
                            }
                        ...
                        {
                            path: '/TheDealFailed',
                            component: () => import('../view/Sharing-Qianlima/Orderment/TheDealFailed/TheDealFailed.vue'),
                            // component: Index,
                            meta: {
                                title: '交易失败'
                            }
                ...
                {
                    path: '/haveindetails',
                    component: () => import('../view/Sharing-Qianlima/Orderment/conponents/haveindetails.vue'),
                    // component: Index,
                    meta: {
                        title: '进行中详情页'
                    }
                ...
                },
                {
                    ...
                    component: () => import('../view/Expandfunction/detailsPageinfo/detailsPageinfo.vue'),
                    // component: Index,
                    meta: {
                        title: '发布公告'
                    }
                ...
                {
                    path: '/SettleIn',
                    component: () => import('../view/Expandfunction/SettleIn/SettleIn.vue'),
                    // component: Index,
                    meta: {
                        title: '商家入驻申请'
                    }
                ...
                {
                    path: '/Report',
                    component: () => import('../view/Expandfunction/Report/Report.vue'),
                    // component: Index,
                    meta: {
                        title: '投诉举报'
                    }
                ...
                {
                    path: '/feedback',
                    component: () => import('../view/Expandfunction/feedback/feedback.vue'),
                    // component: Index,
                    meta: {
                        title: '帮助反馈'
                    }
                ...
                // ======================
                {
                    ...
                    component: () => import('../view/Expandfunction/ViewDetailsPage/ViewDetailsPage.vue'),
                    // component: Index,
                    meta: {
                        title: '查看详情'
                    }
                ...
                {
                    path: '/cooperationGl',
                    component: () => import( /* webpackChunkName: "cooperationGl" */ '../components/merchantHoutai/terrace/cooperation/cooperationGl.vue'),
                    // component: Index,
                    meta: {
                        title: '企业合作'
                    }
                ...
                {
                    path: '/business',
                    component: () => import( /* webpackChunkName: "business" */ '../components/merchantHoutai/business/business.vue'),
                    // component: Index,
                    meta: {
                        title: '商机列表'
                    }
                ...
                {
                    path: '/jobVacancy',
                    component: () => import( /* webpackChunkName: "JobVacancy" */ '../components/merchantHoutai/JobVacancy/jobVacancy.vue'),
                    // component: Index,
                    meta: {
                        title: '职位列表'
                    }
                ...
                {
                    path: '/couponConList',
                    component: () => import( /* webpackChunkName: "localgroup" */ '../components/merchantHoutai/couponControl/couponConList.vue'),
                    meta: {
                        title: '优惠券列表'
                    }
                },
                ...
                {
                    path: '/coupon',
                    component: () => import( /* webpackChunkName: "coupon" */ '../components/merchantHoutai/activity/coupon/coupon.vue'),
                    // component: Index,
                    meta: {
                        title: '优惠卷活动'
                    }
                ...
                {
                    path: '/localgroup',
                    component: () => import( /* webpackChunkName: "localgroup" */ '../components/merchantHoutai/activity/localgroup/localgroup.vue'),
                    meta: {
                        title: '同城团购活动'
                    }
                },
                ...
                {
                    path: '/seckillgl',
                    component: () => import( /* webpackChunkName: "seckill" */ '../components/merchantHoutai/activity/seckill/seckillgl.vue'),
                    // component: Index,
                    meta: {
                        title: '秒杀活动'
                    }
                ...
                {
                    path: '/discount',
                    component: () => import( /* webpackChunkName: "discount" */ '../components/merchantHoutai/activity/discount/discount.vue'),
                    // component: Index,
                    meta: {
                        title: '折扣活动'
                    }
                ...
                {
                    path: '/warehouses',
                    component: () => import( /* webpackChunkName: "warehouses" */ '../components/merchantHoutai/activity/warehouses/warehouses.vue'),
                    meta: {
                        title: '清仓活动'
                    }
                },
                ...
                {
                    path: '/raffleLottery',
                    component: () => import( /* webpackChunkName: "raffleLottery" */ '../components/merchantHoutai/activity/raffleLottery/raffleLottery.vue'),
                    meta: {
                        title: '抽奖活动'
                    }
                },
                ...
                {
                    path: '/flashSale',
                    component: () => import( /* webpackChunkName: "flashSale" */ '../components/merchantHoutai/activity/flashSale/flashSale.vue'),
                    meta: {
                        title: '限时抢购活动'
                    }
                },
                ...
                {
                    path: '/company',
                    component: () => import( /* webpackChunkName: "company" */ '../components/merchantHoutai/activity/company/company.vue'),
                    meta: {
                        title: '企业活动管理'
                    }
                },
                ...
                {
                    path: '/dynamicState',
                    component: () => import( /* webpackChunkName: "dynamicState" */ '../components/merchantHoutai/dynamicState/Dynamic/dynamicState.vue'),
                    meta: {
                        title: '图文动态'
                    }
                },
                ...
                {
                    path: '/articleDynamic',
                    component: () => import( /* webpackChunkName: "dynamicState" */ '../components/merchantHoutai/dynamicState/articDynamin/articleDynamic.vue'),
                    meta: {
                        title: '文章动态'
                    }
                },

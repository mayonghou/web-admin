...
<!-- 抽奖管理 -->
    <div class="table_css_xiaoyuer">
        <div class="top-compo">
            <Row style="width: 100%">
                <Col span="12">
                    <Input v-model="value01" placeholder="输入活动关键字..." clearable style="width: 200px; margin-right: 10px" />
        ...
        <!-- 表格 -->
        <tablea v-if="Datar12 != ''" :pageid="pageid" :Datar12='Datar12'></tablea>
        <!-- 分页 -->
        <el-pagination
            class="pagintion"
    ...
    methods: {
        ...
        GetDataAjax(){
            ...
            this.$axios.post(url,data).then((res)=>{
                var AjaxData12 = res.data.list;
                this.$nextTick(() => {
                    this.Datar12 = AjaxData12;
                })
            }).catch((err)=>{

<template>
	<div class="sidebar">
		<el-menu class="sidebar-el-menu" :default-active="onRoutes" :collapse="collapse" background-color="#393D49"
					...
					<el-submenu :index="item.index" :key="item.index">
						...
						<template v-for="subItem in item.subs">
							<el-submenu v-if="subItem.subs" :index="subItem.index" :key="subItem.index">
								...
								<el-menu-item v-for="(threeItem,index) in subItem.subs" :key="index" :index="threeItem.index">{{ threeItem.title }}</el-menu-item>
							</el-submenu>

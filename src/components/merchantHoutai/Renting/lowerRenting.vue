<template>
	<div id="renting" class="renting" v-loading="fullscreenLoading" :element-loading-text="loadingText" element-loading-background="rgba(0, 0, 0, 0.7)">
		<div class="renting-top">
			...
			<div class="reat-search">
				...
				<el-select class="select-el" v-model="value" @change="changetype" placeholder="房源类型" clearable>
					<el-option v-for="(item,index) in options" :key="item.id" :label="item.typeName" :value="item.id">
					</el-option>
				</el-select>
		...
		<el-table :data="tableData" border style="width: 100;" @selection-change="delallselection">
			...
			<el-table-column prop="houseTitle" label="房源名称" align="center" width="180">
			</el-table-column>
			<el-table-column prop="publisher" label="发布人" align="center" width="">
			</el-table-column>
			<el-table-column prop="phone" label="手机号码" align="center">
			</el-table-column>
			<el-table-column prop="status" label="房源状态" align="center">
			</el-table-column>
			<el-table-column prop="typeName" label="房源类型" align="center">
			</el-table-column>
			<el-table-column prop="time" label="下架时间" align="center">
			</el-table-column>

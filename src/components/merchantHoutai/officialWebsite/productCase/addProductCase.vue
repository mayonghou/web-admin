	...
	<div class="addProductCase" id="addProductCase">
		...
		<el-form :model="addproduct" :rules="rules" ref="addproduct">
			<el-form-item label="产品图片或者视频:" prop="productUrl" label-width="230px">
				...
				<div v-else>
					<img width="200" v-show="this.isShow == true" height=" 200" :src="this.addproduct.productUrl" />
					<video
						ref="videoPlayer"
						width="300"
						height="148"
			...
			<el-form-item label="产品描述:" prop="title" label-width="230px">
				<el-input v-model="addproduct.title" type="textarea"  maxlength="100" show-word-limit class="input" placeholder="输入产品案例标题"></el-input>
			</el-form-item>
		</el-form>
		<div class="product">

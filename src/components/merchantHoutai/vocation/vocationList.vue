<template>
	<div class="header" id="vocationList">
		<div class="header_Top">
			<div class="top_text"><label>行业查询</label></div>
		...
		<el-table :data="tableData" style="width: 100%; margin: 0 auto; background: #F5F9F1;">
			...
			<el-table-column prop="name" label="行业全称" width="180">
			</el-table-column>
			<el-table-column prop="phone" label="行业简介">
			</el-table-column>
		...
		<el-dialog title="添加行业" :visible.sync="dialogVisibleVocation" width="50%">
			...
			<el-form :model="vocationform" :rules="rules" ref="vocationform">
				<el-form-item label="行业名称:" prop="vocationName" :label-width="formLabelWidth">
					<el-input class="formWidth" v-model="vocationform.vocationName" placeholder="请输入行业名称"></el-input>
				</el-form-item>
				<el-form-item label="行业简称:" prop="abbreviation" :label-width="formLabelWidth">
					<el-input class="formWidth" v-model="vocationform.abbreviation" placeholder="请输入行业简称"></el-input>
				</el-form-item>
			</el-form>
		...
		<el-dialog title="修改行业" :visible.sync="dialogVisibleUpdateVocation" width="50%">
			...
			<el-form :model="updateform" :rules="rules" ref="vocationform">
				<el-form-item label="行业名称:" prop="vocationName" :label-width="formLabelWidth">
					<el-input class="formWidth" v-model="updateform.vocationName" placeholder="请输入行业名称"></el-input>
				</el-form-item>
				<el-form-item label="行业简称:" prop="abbreviation" :label-width="formLabelWidth">
					<el-input class="formWidth" v-model="updateform.abbreviation" placeholder="请输入行业简称"></el-input>
				</el-form-item>
			</el-form>
			<span class="dialog-footer">
				<el-button class="button">保存</el-button>

    ...
    <div class="marketing-img" id="marketing-img">
        <div class="marktingvideo-top">
            ...
            <div class="videoList">
                ...
                <div class="listVideo">
                    <el-row>
                        <el-col :span="8" v-for="item in this.imgList" :key="item.id">
        ...
        <el-dialog :visible.sync="dialogVisible" width="70%">
            <div class="dialogText">
                ...
                <div class="dialogBody">
                    <img width="90%" height="90%" :src="this.datadialog.pictureUrl" />
...
export default {
    ...
    methods: {
        ...
        rihgtData(datadialog) {
            ...
            console.log(ind);
            // console.log('this.imgList.length', this.imgList.length - 1);

            // if (this.imgList.length != this.imgid) {
            //
            // } else {
            //     this.$message('已经到达最后一张了哦');
            // }
        },
        // 向左
        xaingzuo(datadialog) {
            this.imgid = datadialog.id + 1;

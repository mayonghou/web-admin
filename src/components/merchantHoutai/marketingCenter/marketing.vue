		...
		<div class="marketing-body">
			...
			<div class="body-center">
				<div class="center-top">
					...
					<div class="center-gengduo">更多 >></div>
				</div>
				<div class="center-body">
					<ul class="center-ul">
						<li class="center-li clearfix" v-for="(item,index) in this.yingxiaoxiaozhishi" :key="index">
							<div class="cneter-li-top">
								<div class="dianTitle">
									<div class="li-dian"></div>
									<div class="title">{{item.title}}</div> <!--小知识标题-->
								</div>
			...
			<div class="body-right">
				...
				<div class="body-right-body">
					<ul class="right-body-ul">
						<li class="right-body-li" v-for="(item,i) in this.activityList" :key="i">

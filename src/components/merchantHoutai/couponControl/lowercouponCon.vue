<template>
	<!-- 上架的视频 -->
	<div class="lowercoupon" id="lowercoupon" v-loading="fullscreenLoading" :element-loading-text="loadingText"
	 element-loading-background="rgba(0, 0, 0, 0.7)">
		...
		<el-table :data="tableData" style="width: 1200px;margin: 0 auto;">
			...
			<el-table-column prop="createByPhone" label="手机号码" align="center" width="">
			</el-table-column>

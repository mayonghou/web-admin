<template>
    <div class="membership" id="membership">
        <div class="membershipTop clearfix">
            <div class="top_text"><label>用户查询</label></div>
            <div class="search">
        ...
        <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="companyName" label="绑定企业"> </el-table-column>
            <el-table-column prop="role" label="会员组"> </el-table-column>

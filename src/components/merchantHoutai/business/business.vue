<template>
    ...
    >
        <div class="searc-top">
            ...
            <div class="businessdatasquery">
                <el-input v-model="busInput" class="el-imput" placeholder="请输入项目名称"></el-input>
                <i
                    style="font-size: 22px;color: #2494D2;margin-left: 38px;margin-top: 5px;"
                    class="el-icon-date"
                ></i>
                <el-date-picker
        ...
        <el-table :data="tableData" border style="width: 100%" @selection-change="seleectChange">
            ...
            <el-table-column prop="type" label="商机类型" align="center"></el-table-column>

<template>
	...
	<div class="addbusiness" id="addbusiness">
		<div class="addbusiness-top"><label>填写商机发布信息</label></div>
		<el-form :model="addbus" :rules="rules" ref="addbus">
			...
			<el-form-item label="行业类型:" prop="hangyeleixing" :label-width="labelwidth">
				<el-select v-model="addbus.hangyeleixing" placeholder="行业类型">
					<el-option v-for="(item,index) in option" :key="item.id" :label="item.name" :value="item.id"></el-option>
				</el-select>
			</el-form-item>
			<el-form-item label="商机类型:" prop="busleixing" :label-width="labelwidth">
				<el-select v-model="addbus.busleixing" placeholder="商机类型">
					<el-option v-for="(item,index) in busOption" :key="item.id" :label="item.name" :value="item.id"></el-option>
				</el-select>
			</el-form-item>
			<el-form-item label="商机标签:" prop="tdynamicTags" :label-width="labelwidth">
				<el-tag :key="item" v-for="item in this.addbus.tdynamicTags" v-model="addbus.tdynamicTags" class="eltag" closable
				 :disable-transitions="false" @close="handleClose(tdynamicTags)">
					{{item}}
				</el-tag>
			...
			<el-form-item label="项目描述:" prop="xiangmumiaoshu" :label-width="labelwidth">
				...
				<quill-editor ref="myQuillEditor" :content='content' v-model="addbus.xiangmumiaoshu" :options="editorOption"></quill-editor>
			</el-form-item>
			<el-form-item label="项目所在地:" prop="address" :label-width="labelwidth">
				<el-cascader v-model="addbus.address" :options="addressOptions" @change="handleChange" placeholder="请选择"></el-cascader>

<template>
	...
	<div class="aeditbusiness" id="aeditbusiness">
		<div class="addbusiness-top"><label>修改商机信息</label></div>
		<el-form :model="editbus" :rules="rules" ref="editbus">
			...
			<el-form-item label="商机标签:" prop="tdynamicTags" :label-width="labelwidth">
				<el-tag :key="item" v-for="item in this.editbus.tdynamicTags" v-model="editbus.tdynamicTags" class="eltag" closable
			...
			<el-form-item label="项目描述:" prop="xiangmumiaoshu" :label-width="labelwidth">
				...
				<quill-editor ref="myQuillEditor" :content='content' v-model="editbus.xiangmumiaoshu" :options="editorOption"></quill-editor>
			</el-form-item>
			<el-form-item label="项目所在地:" prop="address" :label-width="labelwidth">
				<el-cascader v-model="editbus.address" :options="editressOptions" @change="handleChange"></el-cascader>

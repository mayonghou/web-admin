    ...
    <div class="addcouponhedong" id="addcouponhedong">
        ...
        <el-form :model="addcoupon" :rules="rules" ref="addcoupon">
            ...
            <el-form-item label="选择活动优惠券:" prop="selhdcoupon" :label-width="labelWidth">
                ...
                <el-button
                    @click="guanlian"
                    v-else-if="this.addcoupon.selhdcoupon == ''"
            ...
            <el-form-item label="发布数量:" prop="numbers" :label-width="labelWidth">
                <el-input
                    class="inputEl"
                    v-model.number="addcoupon.numbers"
                    placeholder="例如:该优惠券还有 2222 "
                ></el-input>
            ...
            <el-form-item label="领劵限制:" prop="astrictNum" :label-width="labelWidth">
                <el-input
                    class="inputEl"
                    v-model.number="addcoupon.astrictNum"
        ...
        <el-dialog title="关联优惠券" :visible.sync="dialogVisible" width="80%">
            ...
            <el-table :data="tableData" border style="width: 100%;">
                <el-table-column prop="order" type="index" label="序号" width="100" align="center"></el-table-column>
                ...
                <el-table-column label="操作" width="250" align="center">
                    <template slot-scope="scope">
                        <el-button
                            ...
                            v-show="scope.row.bindabilityStatus == 0 && scope.row.id != shoppId"
                            class="bulebutton"
                            size="small"
                        >选择关联</el-button>
                        <el-button
                        ...
                        <el-button
                            type="text"
                            style="color: #FF8D00;"
                            v-show="scope.row.bindabilityStatus != 0"
                            size="small"
                        >已关联</el-button>
                    </template>
                </el-table-column>

    ...
    >
        ...
        <el-form :model="detailcoupon" ref="detailcoupon">
            <el-form-item label="活动标题:" prop="actTitle" :label-width="labelWidth">
                <label class="seleLabel">{{detailcoupon.actTitle}}</label>
            </el-form-item>

<template>
    ...
    <div class="detailWarehourese" id="detailWarehourese">
        <div class="detail-top">
            <label style="margin-left: 20px">清仓出来活动详情</label>
        </div>
        <el-form :model="detailWarehou">
            <el-form-item label="活动商品:" label-width="130px">
                <div
                    class="warehou"
                    v-for="item in this.detailWarehou.activityShopp"
                    :key="item.index"
                >
                    <div class="warehou-a">
            ...
            <el-form-item label="活动标签:" label-width="130px">
                <el-tag
                    ...
                    effect="plain"
                    type="info"
                    v-for="item in this.detailWarehou.tdynamicTags"
                    v-model="detailWarehou.tdynamicTags"
                    class="eltag"
                >{{ item }}</el-tag>
            </el-form-item>
            <el-form-item label="活动时间:" label-width="130px">
                <el-date-picker
                    v-model="detailWarehou.time"
                    type="monthrange"
                    readonly

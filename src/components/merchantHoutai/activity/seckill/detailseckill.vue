<template>
	<div class="detailseckill" id="detailseckill">
		<div class="coupon-top"><label>秒杀活动信息</label></div>
		<el-form :model="detailseckill" ref="detailseckill">
			...
			<el-form-item label="活动商品:" :label-width="labelWidth">
				<el-button v-model="detailseckill.goods" @click="goodDetail" type="text" class="inputText">{{detailseckill.goods}}</el-button>
			</el-form-item>
			...
			<el-form-item label="活动标签:" :label-width="labelWidth">
				<el-tag effect="plain" type="info" :key="item" v-for="item in this.detailseckill.tdynamicTags" v-model="detailseckill.tdynamicTags" class="eltag">
					{{item}}
				</el-tag>
			</el-form-item>

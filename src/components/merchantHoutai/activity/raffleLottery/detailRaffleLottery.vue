<template>
	<div class="detailRaffleLottery" id="detailRaffleLottery">
		<div class="detail-top"><label style="margin-left: 30px;">抽奖活动信息</label></div>
		<el-form :model="detailFrom">
			<el-form-item label="活动标题:" :label-width="labelwidth">
				<el-input class="elinput" placeholder="请输入活动的标题" readonly v-model="detailFrom.title"></el-input>
			</el-form-item>
			<el-form-item label="活动奖品:" :label-width="labelwidth">
				<div class="prizeItemList" v-for="item in this.detailFrom.prizeItemList" :key="item.prizeLevel">
					<div class="aaa grade">
			...
			<el-form-item label="每日抽奖机会:" :label-width="labelwidth">
				<label v-model="detailFrom.chanceNumPerDay">{{detailFrom.chanceNumPerDay}}次</label>
			</el-form-item>
			<el-form-item label="总中奖概率:" :label-width="labelwidth">
				<label v-model="detailFrom.winRate">{{detailFrom.winRate}}%</label>
			</el-form-item>
			<el-form-item label="总中奖机会:" :label-width="labelwidth">
				<label v-model="detailFrom.maxChanceNum">{{detailFrom.maxChanceNum}}次</label>
			</el-form-item>
			<el-form-item label="活动规则:" :label-width="labelwidth">
				<el-input class="elinput" type="textarea" placeholder="请输入活动的标题" readonly v-model="detailFrom.ruleDescription"></el-input>
			</el-form-item>
...
<script>
	export default {
		...
		methods: {
			...
			// 		this.detailFrom.prizeItemList = data.prizeItemList;
			// 		console.log(data.prizeItemList);
			// 	}
			// },
			getraffData() {
				const prizeLevel = {

<template>
    ...
    <div class="flashSaleDetail" id="flashSaleDetail">
        <div class="flashSaleDetail-top">
            <label style="margin-left: 20px;">限时抢购活动详情</label>
        </div>
        <el-form :model="flashDetail" ref="flashDetail">
            <el-form-item label="活动商品:" label-width="230px">
                <el-button
                    ...
                    @click="goodsDetail"
                    class="activityInput"
                >{{this.flashDetail.productName}}</el-button>
            </el-form-item>
            ...
            <el-form-item label="活动标签:" label-width="230px">
                <el-tag
                    ...
                    type="info"
                    :key="item"
                    v-for="item in this.flashDetail.activityTabs"
                    v-model="flashDetail.activityTabs"
                    class="eltag"
                >{{item}}</el-tag>
            </el-form-item>

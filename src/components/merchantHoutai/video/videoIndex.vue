<template>
    ...
    >
        <div class="video-top">
            ...
            <div class="videoList">
                <el-input class="videoInput" placeholder="输入视频标题" v-model="videoInput" clearable></el-input>
                <i
        ...
        <el-table :data="tableData" border style="width: 100%;">
            ...
            <el-table-column prop="title" label="视频标题" align="center" width="180"></el-table-column>
            <el-table-column prop="publisher" label="发布人" align="center" width></el-table-column>
            <el-table-column prop="publisherPhone" label="手机号码" align="center" width></el-table-column>
            <el-table-column prop="name" label="关联的商品名称" align="center"></el-table-column>

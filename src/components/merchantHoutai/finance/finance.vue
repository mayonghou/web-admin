<template>
	...
	<div class="finance" id="finance">
		<div class="caiwu-top">
			<div class="account">
				...
				<div class="account-num">
					<div class="shoppyee"><label>商户当前余额</label></div>
					<div class="number">
			...
			<div class="jiluchaxun">
				...
				<div class="search-tinajian">
					...
					<i style="font-size: 22px;color: #2494D2;margin-left: 38px;margin-top: 5px; margin-right: 38px;" class="el-icon-date"></i>
		...
		<el-table :data="tableData" style="width: 1200px;margin: 0 auto;">
			<el-table-column type="index" prop="" label="序号" align="center" width="80">
			</el-table-column>
			<el-table-column prop="" label="流水号" align="center">
			</el-table-column>
			<el-table-column prop="" label="订单编号" width="150" align="center">
			</el-table-column>
			<el-table-column prop="" label="金额" align="center">
			</el-table-column>
			<el-table-column prop="" label="支付平台" align="center">
			</el-table-column>
			<el-table-column prop="" label="入账时间" align="center">
			</el-table-column>
		</el-table>
		<!-- 页码 -->

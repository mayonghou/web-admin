<template>
	<div class="kehuadmin" id="kehuadmin" v-loading="fullscreenLoading" :element-loading-text="loadingText"
	 element-loading-background="rgba(0, 0, 0, 0.7)">
		<div class="kehuadminTop clearfix">
			<div class=""><label>客户查询</label></div>
		...
		<el-table :data="tableData" border style="width: 100%;">
			...
			<el-table-column prop="id" label="客户id" align="center" width="">
			</el-table-column>
			...
			<el-table-column prop="lastLoginTime" width="150" align="center" label="最后登录时间">
			</el-table-column>
			<el-table-column prop="consumerService" align="center" label="客服">
			</el-table-column>

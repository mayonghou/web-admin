<template>
	<div class="enterprise" id="editEnterprise">
		<div class="add_from">
			<el-form ref="formData" :model="formData">
				...
				<el-form-item label="营业执照:" prop="licenseUrl" :label-width="formLabelWidth">
					<el-upload
						...
						ref="upload"
					>
						<img width="100%" height="100%" v-if="formData.licenseUrl" :src="formData.licenseUrl" class="avatar">
					    <i v-show="formData.licenseUrl == ''" class="el-icon-plus yinyezhizhao avatar-uploader-icon"></i>
					</el-upload>
				...
				<el-form-item label="所属行业:" prop="industry" :label-width="formLabelWidth">
					<el-select class="formWidth" v-model="formData.industry" placeholder="请选择">
						<el-option v-for="item in optionIndus" :label="item.name" :key="item.id" :value="item.id"></el-option>
					</el-select>
				</el-form-item>
				...
				<el-form-item label="注册地址:" prop="registerAddress" :label-width="formLabelWidth">
					...
					<el-input class="formWidth inputdasd" v-model="formData.registerAddressDetail" placeholder="请输入详细地址"></el-input>
				</el-form-item>
				<el-form-item label="经营地址:" prop="address" :label-width="formLabelWidth">
					...
					></el-cascader>
					<label style="margin-left: 30px;">详细地址:</label>
					<el-input class="formWidth inputdasd" v-model="formData.addressDetail" placeholder="请输入详细地址"></el-input>
				</el-form-item>
				<el-form-item label="注册资本:" prop="registerMoney" :label-width="formLabelWidth">
					<el-input class="formWidth" v-model="formData.registerMoney"></el-input><label style="margin-left: 20px;">万</label>
				</el-form-item>
				...
				<el-form-item label="企业背景图:" prop="backgroundImage" :label-width="formLabelWidth">
					<el-upload
						...
						ref="upload"
					 >
						<img v-if="formData.backgroundImage" :src="formData.backgroundImage" class="avatar bgImage uploadIed">
					</el-upload>
				...
				<el-form-item label="企业logo:" prop="logoUrl" :label-width="formLabelWidth">
					<el-upload
					  ...
					  ref="upload"
					 >
						<img v-if="formData.logoUrl" :src="formData.logoUrl" class="avatar logoImg uploadIed">
					</el-upload>
				...
				<el-form-item label="身份证图片:" prop="frontImage" :label-width="formLabelWidth">
					<el-upload
						...
						ref="upload"
					>
						<img v-if="formData.frontImage" :src="formData.frontImage" class="avatar frontImage uploadIed">
					</el-upload>
				...
				<el-form-item label="" prop="backImage" :label-width="formLabelWidth">
					<el-upload
						...
						ref="upload"
					>
						<img v-if="formData.backImage" :src="formData.backImage" class="avatar backImage uploadIed">
					</el-upload>
			...
			<div style="width: 100%;"><el-button @click="SaveChanges" class="addBut">保存更改</el-button></div>
		</div>
	</div>
</template>

	...
	<div class="AdvocacyMyShpping" id="AdvocacyMyShpping">
		<div class="header_Top">
			...
			<div class="top_search">
				...
				<div class="sear_time">
					<el-date-picker prefix-icon="md-date_range" value-format="yyyy-MM-dd" v-model="times" type="daterange" start-placeholder="开始日期"
					 end-placeholder="结束日期">
					</el-date-picker>
					<el-button @click="wodiayancahxuan" class="button">查询</el-button>
				</div>
			</div>
		</div>
		<div class="label-button">
			<div class="label">
				<label>我代言的产品列表</label>
			</div>
		...
		<el-table :data="tableData" style="width: 100%; margin: 0 auto;">
			...
			<el-table-column prop="viewCount" label="代言人数">
			</el-table-column>
...
<script>
	export default {
		...
		methods: {
			...
			// 查询我代言的产品列表
			myAdvocacyList() {
				let beginTime = this.times[0] || 0;
				let endTime = this.times[1] || 0;

		...
		<div class="add_from">
			...
			<el-form ref="addform" :model="addform">
				...
				<el-form-item label="营业执照:" prop="licenseUrl" :label-width="formLabelWidth">
					...
					<img v-if="addform.licenseUrl" width="100" height="60" :src="addform.licenseUrl" class="avatar uploadImg">
				...
				<el-form-item label="企业背景图:" prop="backgroundImage" :label-width="formLabelWidth">
					<img v-if="addform.backgroundImage" width="100" height="60" :src="addform.backgroundImage" class="avatar uploadImg">
				...
				<el-form-item label="身份证图片:" prop="papersImage" :label-width="formLabelWidth">
					<img v-if="addform.papersImage" :src="addform.papersImage" class="avatar uploadImg">
				...
				<el-form-item label="账号类型:" prop="bankType" :label-width="formLabelWidth">
					<el-select class="formWidth form" popper-class="select-option" v-model="addform.bankType" disabled>

        ...
        <div class="order-top">
            ...
            <div class="reat-search">
                ...
                <el-date-picker
                    ...
                    @change="templateTime"
                ></el-date-picker>
                <el-select class="select-elsd" v-model="value" placeholder="全部订单状态" clearable>
                    <el-option
                ...
                <el-select class="select-elsd" v-model="reatState" placeholder="全部配送类型" clearable>
                    <el-option
...
.select-elsd .el-input {
    width: 200px;
}
.select-elsd .el-input .el-input__inner {
    width: 200px;
}

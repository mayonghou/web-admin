<template>
	<div id="jobVacancy" class="renting jobVacancy" v-loading="fullscreenLoading" :element-loading-text="loadingText" element-loading-background="rgba(0, 0, 0, 0.7)">
		<div class="renting-top">
			...
			<div class="reat-search">
				...
				<el-select class="select-el" v-model="value" placeholder="全部行业" clearable @change="industryId">
					<el-option v-for="item in optionslist" :key="item.id" :label="item.name" :value="item.id"></el-option>
				</el-select>
				<el-select class="select-el" v-model="value2" placeholder="行业下的职位" clearable @change="zhiweiName">
					<el-option v-for="item in optionpos" :key="item.id" :label="item.jobName" :value="item.id"></el-option>
				</el-select>
				<el-select class="select-el" v-model="reatState" placeholder="全部职位状态" clearable>
					<el-option v-for="item in reatStates" :key="item.value" :label="item.label" :value="item.value">
					</el-option>
				</el-select>
		...
		<el-table :data="tableData" style="width: 100%;" border>
			<el-table-column prop="jobName" label="职位名称" align="center" width="180">
			</el-table-column>
			<el-table-column prop="contact" label="发布人" align="center">
			</el-table-column>
			...
			<el-table-column prop="positionType" label="职位类型" align="center">
			</el-table-column>
			<el-table-column prop="publishDate" label="发布时间" align="center" width="130">
			</el-table-column>

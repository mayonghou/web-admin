		...
		<el-form :model="addjob" :rules="rules" ref="addjob">
			...
			<el-form-item label="职位名称:" prop="positionJob" :label-width="labelwidth">
				<el-select v-model="addjob.positionJob" placeholder="请选择" @change="positionJobs">
					<el-option v-for="(item,index) in optionpos" :key="item.id" :label="item.jobName" :value="item.id"></el-option>
				</el-select>
			</el-form-item>
			...
			<el-form-item label="福利待遇:" prop="benefits" :label-width="labelwidth">
				<el-checkbox-group v-model="addjob.benefits">
					<el-checkbox v-for="(item,index) in fulidaiyu" :label="item.id" :key="index">{{item.welfare}}</el-checkbox>
				</el-checkbox-group>
			</el-form-item>
			...
			<el-form-item label="工作年限:" prop="ageLimit" :label-width="labelwidth">
				<el-select v-model="addjob.ageLimit" @change="ageChange" placeholder="请选择">
					<el-option v-for="(item,index) in ageList" :key="item.id" :label="item.name" :value="item.id"></el-option>
				</el-select>
			</el-form-item>
			...
			<el-form-item label="岗位描述:" prop="postdescribe" :label-width="labelwidth">
				<el-input class="textarea" type="textarea" placeholder="输入岗位描述" v-model="addjob.postdescribe" maxlength="800"
				 show-word-limit>
				</el-input>
			</el-form-item>
			<el-form-item label="团队介绍:" prop="teamIntroduction" :label-width="labelwidth">
				<el-input class="textarea" type="textarea" placeholder="输入团队描述" v-model="addjob.teamIntroduction" maxlength="500"
				 show-word-limit>
				</el-input>
			</el-form-item>
		</el-form>

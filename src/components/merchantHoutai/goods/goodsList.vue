<template>
	<div id="goodsList" class="goodsList" v-loading="fullscreenLoading" :element-loading-text="loadingText"
	 element-loading-background="rgba(0, 0, 0, 0.7)">
		...
		<el-table :data="tableData" border style="width: 100%;">
			...
			<el-table-column prop="lowerShelfTime" label="商品货号" width="120" align="center">
			</el-table-column>
			<el-table-column prop="createTime" label="发布时间" align="center" width="200">
			</el-table-column>
			<el-table-column label="操作" width="280" align="center">
				<template slot-scope="scope">
					<el-button @click="recommendTuijian(scope.row)" v-if="scope.row.recommend == 0 " class="xianqing tab_button">设为推荐</el-button>
		...
		<el-dialog title="共享千里马福利" :visible.sync="dialogVisibleake" width="50%">
			...
			<div class="">
				...
				<div class="dadaetal">
					<div>
						<label>
							1. 商品图不好看？来这儿找找专业的平面设计，你就就是下一个伯乐。
						</label>
					</div>
					<div>
						<label>

<template>
	<!-- 商品详情 -->
	<div class="goodsDetail" id="goodsDetail" v-loading="fullscreenLoading" :element-loading-text="loadingText" element-loading-background="rgba(0, 0, 0, 0.7)">
		...
		<div class="textnext">
			<el-form :model="goodsDetailList">
				...
				<el-form-item label="商品视频:" :label-width="labelwidth">
					<video ref="videoPlayer" v-if="goodsDetailList.fileUrl" controls :src="goodsDetailList.fileUrl" controlslist="nodownload" @play="toPlays"
					 @timeupdate="updateTime" @pause="toPause" class="video">
					</video>
				</el-form-item>
				...
				<el-form-item label="商品主图:" :label-width="labelwidth">
					<div v-model="goodsDetailList.imgSrcList" v-for="(item, index) in this.goodsDetailList.imgSrcList" :key="index">
				...
				<el-form-item label="商品参数:" :label-width="labelwidth">
					...
					<div v-for="(item,index) in this.goodsDetailList.canshu" :key="index">
						...
						<el-form-item style="margin-left: 30px;" :label="'参数'+(index+1)+'详情:'" :label-width="labelw">
				...
				<el-form-item label="商品规格:" :label-width="labelwidth">
					...
					<el-form-item :label="'副规格'+(index+1)+'标题:'" v-for="(item, index) in this.prodAttrSubList" :key="index" :label-width="labelwi">
							<el-input class="goodinput" v-model="item.subTitle" readonly></el-input>
							<el-form-item :label="'副规格'+(ind+1)+'名称:'" v-for="(i,ind) in item.subName" :key="ind" label-width="105px">
				...
				<el-form-item label="商品准备时间:" :label-width="labelwidth">
					<label style="margin-left: 0px;" v-model="goodsDetailList.time">{{goodsDetailList.time}}分钟</label>
				</el-form-item>
			</el-form>

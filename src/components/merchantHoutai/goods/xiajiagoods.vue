<template>
	<div id="xiajiagoods" class="xiajiagoods" v-loading="fullscreenLoading" :element-loading-text="loadingText"
	 element-loading-background="rgba(0, 0, 0, 0.7)">
		<div class="goodsList-top">
			...
			<div class="reat-search">
				...
				<i style="font-size: 22px;color: #2494D2;margin-left: 38px;margin-right: 38px;margin-top: 5px;" class="el-icon-date"></i>
		...
		<el-table :data="tableData" style="width: 100%;margin: 0 auto;" @selection-change="SelectionChange">
			...
			<el-table-column prop="userName" label="发布人" width="" align="center">
			</el-table-column>
			...
			<el-table-column prop="lowerShelfTime" label="商品货号" align="center">
			</el-table-column>
